...
import { getMetricsData } from "../../../../Services/Actions/kriAction";

const Metric = ({SelectKriMetric}:{SelectKriMetric:string}) => {
    const metricTitle = SelectKriMetric;
    ...
    return(
        <>
            ...
            <div className="row">
              <div className="col-5">
                <h6>{metricTitle}</h6>
                <IconButton buttonTitle="Remove" onClick={() => {}} iconPosition="right" variant="remove" color="neutral" icon={<MinusRed />} />
              </div>
              <div className="col-7">
                <div className="row">
                  <div className="col-6">
...
//     const metricId= SelectKriMetric;
//     let kriTitle="";
//     let kriMasterId=0;
...
//       await dispatch(getMetricsData({SelectKriMetric})).then((res:any)=>{
